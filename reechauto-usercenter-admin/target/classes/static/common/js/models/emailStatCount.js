...
layui.define(["table","form","laydate"],function(exports){
    ...
    var emailStatCount = {
        ...
        render : function () {
            ...
            form.on('submit(query)', function(data){
            	...
            	$.post("/api/colibri/stat/emailcount",{"statDate":statDate,"endDate":endDate,"appKey":appKey},function(mydata){
            		 if(mydata.code == 0){
            			 $("#emailStatCount-detail").data("emailDetailAll",mydata.detailAll);
            			 myChart.clear();
            			 ...
            			 table.reload("emailStatCount-table",{
                                 data:mydata.detail
                         });
        ...
        //加载表格事件
        table.on('tool(emailStatCounttable)', function(obj){
       	   var data = obj.data;
           	 if(obj.event == 'emailStatDetail'){
           		 
           		 var detailData =  $("#emailStatCount-detail").data("emailDetailAll");
           		...
           		layui.layer.open({
                        ...
                        ,title: "明细" //不显示标题栏
                        ,area:  ['750px', '500px']
                        ,id: 'emailStatCount-detail-layer' //设定一个id，防止重复弹出
                        ,shade:0
    ...
    exports('emailStatCount', function () {
    	emailStatCount.init();
